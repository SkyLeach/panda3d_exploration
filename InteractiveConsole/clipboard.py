  ...
  def __init__( self ):
    ...
    for rootPath in os.environ['PATH'].split(os.pathsep):
      try:
        ...
        # ignore paths not found, nobody is perfect
        pass
  def __getitem__( self, filename ):
    if filename in self.foundApplications:
...
if sys.platform == 'darwin':
  ...
  and applicationFinder['pbpaste'] is not None:
    class clipboardClass:
      ...
      def getText( self ):
        ...
        cmd.close()
        return out
    logger.info("using pbcopy/pbpaste clipboard")
  else:
    pass
  ...
  try:
    ...
    class clipboardClass:
      ...
      def getText( self ):
        ...
        w.CloseClipboard()
        return d
    logger.info("using win32clipboard")
  except:
    pass
  ...
  try:
    ...
    logger.info("using pyqt clipboard")
    found = True
  except:
    pass
  ...
  try:
    ...
    logger.info("using pydcop clipboard")
    found = True
  except:
    pass
  ...
  try:
    ...
    logger.info("using pygtk/gtk clipboard")
    found = True
  except:
    pass
  ...
  if found:
    ...
    class clipboardClass:
      ...
      def getText( self ):
        ...
        cmd.close()
        return out
    logger.info("using xsel clipboard")
    ...
    class clipboardClass:
      ...
      def getText( self ):
        ...
        cmd.close()
        return out
    logger.info("using xclip clipboard")
  else:
    logger.warn("clipboard environment found!")


# if not clipboard could be created, use a dummy
if clipboardClass is None:
  logger.error("no clipboard module found for platform %s" % sys.platform)
