  ...
  def __init__( self, parent ):
    ...
    if sys.platform == 'linux2' or sys.platform == 'darwin':
      try:
        ...
        traceback.print_exc()
        logger.debug("interactiveConsole.consoleKeyreaderClass.__init__ cannot set reading non-blocking, skipping console mode\n")
    else:
      success = True

    if success:
      if DEBUG:
        logger.debug("interactiveConsole.consoleKeyreaderClass.__init__\n")
